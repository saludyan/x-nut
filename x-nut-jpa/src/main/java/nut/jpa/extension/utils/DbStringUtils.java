...
public class DbStringUtils {
    ...
    public static String blob2String(Blob blob) {
        if (null != blob) {
            try {
                ...
                throw new XJpaException("Blob Convert To String Error!");
            }
        }
        return null;
    }
    ...
    public static String sqlArgsFill(String content, Object... args) {
        if (DbStringUtils.isEmpty(content)) {
            return null;
        }
        if (args != null) {
    ...
    public static String quotaMark(Object obj) {
        ...
        if (obj instanceof CharSequence) {
            // fix #79
            return DbStringEscape.escapeString(srcStr);
        }
        return srcStr;
    }
    ...
    public static String quotaMarkList(Collection<?> coll) {
        ...
        while (iterator.hasNext()) {
            String tempVal = DbStringUtils.quotaMark(iterator.next());
